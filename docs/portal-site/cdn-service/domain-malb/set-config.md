...
![Step 3 Image](./img/set3.png)

You can edit or delete after creating a configuration

![Step 4 Image](./img/set4.png)

**With Timestamp Anti-Hotlinking (Live):**

![Step 5 Image](./img/set5.png)

![Step 5 Image](./img/set6.png)

Fill full data and submit

![Step 5 Image](./img/set7.png)

You can edit or delete after creating a configuration

![Step 5 Image](./img/set8.png)
